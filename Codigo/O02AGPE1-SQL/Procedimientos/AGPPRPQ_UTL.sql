SET DEFINE OFF;
SET SERVEROUTPUT ON;
CREATE OR REPLACE PACKAGE O02AGPE1.PQ_UTL AUTHID CURRENT_USER IS
/******************************************************************************
   NAME:       UTL
...
END PQ_UTL;
/
CREATE OR REPLACE PACKAGE BODY O02AGPE1.PQ_UTL AS
...
v_valor VARCHAR2(30) := NULL;

BEGIN

 EXECUTE IMMEDIATE ('SELECT AGP_valor FROM o02agpe0.TB_CONFIG_AGP  WHERE AGP_nemo = ''' || p_nemo || '''') INTO v_valor;
