...
<html>
<head>
	<title>Agroplus - Detalle Comisiones</title>
		...
		<script type="text/javascript">
	        ...
	        function onInvokeAction(id) {
			    ...
			    $.get('${pageContext.request.contextPath}/ficheroComision.run?ajax=true&idFichero='+$("#idFichero").val() +'&' + parameterString, function(data) {
			        $("#grid").html(data)
		  			});
			}
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="SwitchSubMenu('sub7', 'sub5');">
		...
		<div class="conten" style="padding:3px;width:97%" >
			<p class="titulopag" align="left">Detalle Fichero Comisiones</p>			
			
			<form name="main2" id="main2" action="ficheroComisionApli.run" method="post" >
				...
				<input type="hidden" name="nombreFichero" id ="nombreFichero" value="${comisionBean.fichero.nombrefichero}"/>
				<input type="hidden" name="estado" id ="estado" value="${estado}"/>
				<input type="hidden" name="fase" id ="fase" value="${comisionBean.fichero.fase.fase}"/>
			</form>
			<form:form name="main1" id="main1" action="ficheroComision.run" method="post"  commandName="comisionBean">
				<input type="hidden" name="method" id="method" />	
				<input type="hidden" name="idFichero" id ="idFichero" value="${idFichero}"/>
						...
						<fieldset><legend class="literal">Datos Fichero</legend>
							<table align="center">
								...
								<td class="literal">Fichero:</td>
									<td width="350px" class="detalI">${comisionBean.fichero.nombrefichero}</td>
								<td class="literal">Estado:</td>
									<td width="350px" class="detalI">${estado}</td>
								<td class="literal">Fase:</td>
									<td width="350px" class="detalI">${comisionBean.fichero.fase.fase}</td>
