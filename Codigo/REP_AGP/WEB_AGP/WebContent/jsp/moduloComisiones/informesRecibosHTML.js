...
//DAA 07/10/2013 informesRecibosHTML.js
...
function obtenerRegistro(numLinea){
	...
	common.mostrarDetalleInformeRecibos_ajax();
}

function showPopupDetalleRecibos(){
	$('#divPopupDetalleRecibos').fadeIn('normal');
}

function cerrarPopupDetalleRecibos(){
	$('#divPopupDetalleRecibos').fadeOut('normal');
	//eliminamos la tabla
