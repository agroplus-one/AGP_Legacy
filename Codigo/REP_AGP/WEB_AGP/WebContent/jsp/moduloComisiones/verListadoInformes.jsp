...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="SwitchMenu('sub5');">
	...
	<div class="conten" style="padding: 3px; width: 97%">
		<p class="titulopag" align="left">Informes de comisiones</p>
		<div id="grid">
			<display:table requestURI="" class="LISTA" summary="ficheroCierre" 
					pagesize="${numReg}" name="${listInformesGenerados}" id="ficheroCierre" 
					decorator="com.rsi.agp.core.decorators.ModelTableDecoratorInformesComisiones" 
					style="width:50%;border-collapse:collapse;">					
					
					<display:column class="literal" headerClass="cblistaImg" title="Fichero"			property="acciones"    		style="text-align:center" sortable="false"/>
					<display:column class="literal" headerClass="cblistaImg" title="Nombre del Informe" property="nombreFichero"	style="text-align:center" sortable="true"/>
			</display:table>
		</div>		
	</div>
