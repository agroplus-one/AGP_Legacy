...
<html>
	<head> 
		<title>Agroplus - Carga desde CSV</title>
		...
		<script type="text/javascript" src="jsp/moduloTaller/cargaCSV/cargaCSV.js"></script>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="SwitchMenu('sub2');">
			...
			<table width="97%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td align="center" width="70%">
						<a class="bot" id="btnPlantilla" href="javascript:plantilla();" title="Plantilla de fichero csv">Plantilla CSV</a>
						<a class="bot" id="btnManual" href="javascript:manual();" title="Manual para cargar CSV">Manual</a>
					</td>
					<td align="right">						
		...
		<p class="titulopag" align="left">Carga de parcelas desde CSV</p>
		
		<%@ include file="/jsp/common/static/avisoErrores.jsp"%>
		
		<!-- Panel de carga de ficheros -->
		<form:form name="formCarga" id="formCarga" action="cargaCSV.html" method="post" enctype="multipart/form-data" commandName="formCsvCargasBean">
			<input type="hidden" id="method" name="method" value="doCargar"/>
			<div class="panel2 isrt" style="width: 99%;margin:0 auto;" align="center">
				<fieldset>
				  <legend class="literal">Carga CSV</legend>
				  
				  	<table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tr>
							<td class="literal" align="right">Plan:&nbsp;&nbsp;</td>
							<td>
								<form:input	path="plan" size="2" maxlength="4" cssClass="dato" id="planCarga" tabindex="1"/>
								<label class="campoObligatorio" id="campoObligatorio_planCarga" title="Campo obligatorio"> *</label>
							</td>	
							
							<td class="literal">L&iacute;nea
							<td class="literal">
								<form:input path="linea" size="2" maxlength="3" cssClass="dato" id="lineaCarga" tabindex="2" onchange="javascript:lupas.limpiarCampos('desc_linea');"/>
							</td>
							<td  class="literal">
								<form:input path="nomLinea" cssClass="dato" id="desc_linea" size="28" readonly="true"/>		
							<!--</td>
							<td  class="literal">-->
							...
							<td>
								...
								<c:if test="${filtroMediador eq false}">
									<form:input	path="entMed" size="3" maxlength="4" cssClass="dato" id="entmediadora_cm" onchange="javascript:lupas.limpiarCampos('subentmediadora_cm');UTIL.subStrEntidad();" tabindex="3"/>
									<label class="campoObligatorio" id="campoObligatorio_entmediadora_cm" title="Campo obligatorio"> *</label>
									<form:input	path="subentMed" size="3" maxlength="4" cssClass="dato" id="subentmediadora_cm" tabindex="4"/>
								...
								<c:if test="${filtroMediador eq true}">
									<form:input readonly="true" path="entMed" size="3" maxlength="4" cssClass="dato" id="entmediadora_cm" onchange="javascript:lupas.limpiarCampos('subentmediadora_cm');UTIL.subStrEntidad();" tabindex="3"/>
									<label class="campoObligatorio" id="campoObligatorio_entmediadora_cm" title="Campo obligatorio"> *</label>
									<form:input	readonly="true" path="subentMed" size="3" maxlength="4" cssClass="dato" id="subentmediadora_cm" tabindex="4"/>
									<label class="campoObligatorio" id="campoObligatorio_subentmediadora_cm" title="Campo obligatorio"> *</label>
								</c:if>
							</td>  
							<td  class="literal">Fichero CSV: </td>
							<td>
								<input type="file" class="dato" id="fileCarga" name="file" tabindex="5"/>
		...
		<form:form name="formLimpiar" id="formLimpiar" action="cargaCSV.html" method="post" commandName="csvCargasBean">
			<input type="hidden" id="method" name="method" value="doConsulta"/>
		</form:form>
		
		<!-- Formulario para descargar la plantilla -->
		<form:form name="formPlantilla" id="formPlantilla" action="cargaCSV.html" method="post">
			<input type="hidden" id="method" name="method" value="doDescargarArchivo"/>
			<input type="hidden" id="tipoArchivo" name="tipoArchivo" value="plantilla"/>
		</form:form>
		
		<!-- Formulario para descargar el manual -->
		<form:form name="formManual" id="formManual" action="cargaCSV.html" method="post">
			<input type="hidden" id="method" name="method" value="doDescargarArchivo"/>
			<input type="hidden" id="tipoArchivo" name="tipoArchivo" value="manual"/>
		</form:form>
		
		<!-- Formulario para ver el contenido de un archivo -->
		<form:form name="formVerContenido" id="formVerContenido" action="cargaCSV.html" method="post" commandName="csvCargasBean">
		...
		<form:form name="formBorrado" id="formBorrado" action="cargaCSV.html" method="post" commandName="csvCargasBean">
		...
		<form:form name="formConsulta" id="formConsulta" action="cargaCSV.html" method="post" commandName="csvCargasBean">
				  ...
				  <legend class="literal">Filtro</legend>
				  	<table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tr>
							...
							<td>
								<c:if test="${filtroEntidad eq false}">
									<form:input path="entidad" size="5" maxlength="4" cssClass="dato" id="entidad" tabindex="6" onchange="javascript:lupas.limpiarCampos('desc_entidad');"/>
								</c:if>
								<c:if test="${filtroEntidad eq true}">
									<form:input path="entidad" size="5" readonly="true" maxlength="4" cssClass="dato" id="entidad" tabindex="7" onchange="javascript:lupas.limpiarCampos('desc_entidad');"/>
								</c:if>
							...
							<td>
								<c:if test="${filtroMediador eq false}">
									<form:input	path="entMed" size="4" maxlength="4" cssClass="dato" id="entmediadora" onchange="javascript:lupas.limpiarCampos('subentmediadora');UTIL.subStrEntidad();" tabindex="8"/>
									<form:input	path="subentMed" size="4" maxlength="4" cssClass="dato" id="subentmediadora" tabindex="9"/>
								...
								<c:if test="${filtroMediador eq true}">
									<form:input	path="entMed" size="4" readonly="true" maxlength="4" cssClass="dato" id="entmediadora" onchange="javascript:lupas.limpiarCampos('subentmediadora');UTIL.subStrEntidad();" tabindex="10"/>
									<form:input	path="subentMed" size="4" readonly="true" maxlength="4" cssClass="dato" id="subentmediadora" tabindex="11"/>
								</c:if>
							</td>
							<td class="literal">Plan:</td>
							<td>
								<form:input	path="plan" size="4" maxlength="4" cssClass="dato" id="plan" tabindex="12"/>
							</td>
							<td class="literal">L&iacute;nea:</td>
							<td>
								<form:input path="linea" size="3" maxlength="3" cssClass="dato" id="linea" tabindex="13" onchange="javascript:lupas.limpiarCampos('desc_linea');"/>
						...
						<tr>
							<td class="literal">Fichero CSV:</td>
							<td>
								<form:input path="nombreFichero" cssClass="dato" id="nombreFichero" size="41" tabindex="14"/>
							</td>
						</tr>
					</table>
				 </fieldset>
		...
		<c:if test="${listCargasCSV != null}">
			<div class="grid" style="">
		        <display:table requestURI="cargaCSV.html" id="listCargasCSV" class="LISTA" summary="CargaCSV" name="${listCargasCSV}" sort="list" pagesize="10" decorator="com.rsi.agp.core.decorators.ModelTableDecoratorCargaCSV" 
