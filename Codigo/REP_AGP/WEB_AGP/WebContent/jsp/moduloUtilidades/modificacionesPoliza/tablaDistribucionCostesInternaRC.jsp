<%@ include file="/jsp/common/static/taglibs.jsp" %>
				...
				<td valign="top" align="center" width="25%" >
					<table>
						...
						<c:if test="${param.tipoDC == 0}">
							<c:forEach items="${distribucionCostes.redCapitalBonifRecargos}" var="bonifRecargo">
								<tr class="literalborde">
									<td class="literalborde" style="border: 0px; text-align: left;">
						...
						<c:if test="${param.tipoDC == 1}">
							<c:forEach items="${diferenciaCostes.redCapitalBonifRecargos}" var="bonifRecargo">
								<tr class="literalborde">
									<td class="literalborde" style="border: 0px; text-align: left;">
				...
				<td valign="top" align="center" width="25%" >
					<table>
						<c:if test="${param.tipoDC == 0}">
							<c:forEach items="${distribucionCostes.redCapitalSubvEnesas}" var="subvEnesa">
								<tr class="literalborde">
									<td class="literalborde" style="border: 0px; text-align: left;">
						...
						<c:if test="${param.tipoDC == 1}">
							<c:forEach items="${diferenciaCostes.redCapitalSubvEnesas}" var="subvEnesa">
								<tr class="literalborde">
									<td class="literalborde" style="border: 0px; text-align: left;">
				...
				<td  valign="top" align="center" width="25%" >
					<table>
						<c:if test="${param.tipoDC == 0}">
							<c:forEach items="${distribucionCostes.redCapitalSubvCCAAs}" var="subvCCAA">
								<tr class="literalborde">
									<td class="literalborde" style="border: 0px; text-align: left;">
						...
						<c:if test="${param.tipoDC == 1}">
							<c:forEach items="${diferenciaCostes.redCapitalSubvCCAAs}" var="subvCCAA">
								<tr class="literalborde">
