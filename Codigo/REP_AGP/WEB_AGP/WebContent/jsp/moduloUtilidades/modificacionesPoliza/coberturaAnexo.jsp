<%@ include file="/jsp/common/static/taglibs.jsp"%>
	...
	<table width="100%" border="1">
		...
		<c:forEach items="${moduloAnexo.riesgoCubiertoModulos}" var="riesgoCbrtoMod">
		<tr>
			...
			<td class="literalborde" align="center" width="15%">
				...
				<c:if test="${riesgoCbrtoMod.elegible == 'S'}" >
					${br}
					<input type="checkbox"
					id="checkAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}"
					name="checkAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}"/>
				</c:if>
			</td>
					...
					<tr>
						<td class="literalborde" align="center" width="20%"><font color="red">${elegCapAseg}</font>
							...
							<c:when test="${elegCapAseg == ''}" >
								...
								<select class="dato" style="width:110px"
								id="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_362"
								name="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_362">
						...
						<td class="literalborde" align="center" width="20%"><font color="red">${elegCalculo}</font>
							...
							<c:when test="${elegCalculo == ''}" >
								...
								<select class="dato" style="width:110px"
									id="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_174" 
									name="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_174">
						...
						<td class="literalborde" align="center" width="20%"><font color="red">${elegMinIndem}</font>
							...
							<c:when test="${elegMinIndem == ''}" >
								...
								<select class="dato" style="width:110px"
									id="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_121"
									name="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_121">
						...
						<td class="literalborde" align="center" width="20%"><font color="red">${elegTipoFranq}</font>
							...
							<c:when test="${elegTipoFranq == ''}" >
								...
								<select class="dato" style="width:110px"
									id="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_170"
									name="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_170">
						...
						<td class="literalborde" align="center" width="20%"><font color="red">${elegPctFranq}</font>
							...
							<c:when test="${elegPctFranq == ''}" >
								...
								<select class="dato" style="width:110px"
									id="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_120"
									name="selectAnexo_${riesgoCbrtoMod.conceptoPpalModulo.codconceptoppalmod}_${riesgoCbrtoMod.riesgoCubierto.id.codriesgocubierto}_120">
