...
<script type="text/javascript">
		function cargarFiltro(){
			...
			<c:if test="${origenLlamada != 'menuGeneral'}">
			    ...
			    var estadoCuponIdValue;

			    switch (filtroValue) {
			        case 'Abierto':
			            estadoCuponIdValue = 1;
			            break;
			        case 'Caducado':
			            estadoCuponIdValue = 2;
			            break;
			        case 'Error':
			            estadoCuponIdValue = 3;
			            break;
			        case 'Error-Rechazado':
			            estadoCuponIdValue = 4;
			            break;
			        case 'Error-Trámite':
			            estadoCuponIdValue = 5;
			            break;
			        case 'Confirmado-Trámite':
			            estadoCuponIdValue = 6;
			            break;
			        case 'Confirmado-Aplicado':
			            estadoCuponIdValue = 7;
			            break;
			        default:
			            estadoCuponIdValue = 0; // Valor por defecto si no coincide ningún caso
			            break;
			    }
					$('#estadoCuponId').val(estadoCuponIdValue);
				</c:if>
				//P0079361
			</c:if>
			</c:forEach>
			$('#tipoEnvioId').val('${sessionScope.reduccionCapitalUtilidadesBean.estadoCuponId}');
			...
			<div id="omitirPrimeraBusquedaBox">
				...
				<form name="exportToExcel" id="exportToExcel"
					...
					<input type="hidden" name="method" id="method"
						...
						<input type="hidden" name="estadoCuponRC" id="estadoCuponRC" value="" />
					    <input type="hidden" name="tipoEnvioRC" id="tipoEnvioRC" value="" />
						<input type="hidden" name="fEEnvio" id="fEEnvio" value="" />
					    <input type="hidden" name="fEEnvioHasta" id="fEEnvioHasta" value="" />
					    <input type="hidden" name="fEdanio" id="fEdanio" value="" />
					    <input type="hidden" name="fEdanioHasta" id="fEdanioHasta" value="" />
					    <input type="hidden" name="fEEnvioPol" id="fEEnvioPol" value="" />
					    <input type="hidden" name="fEEnvioPolHasta" id="fEEnvioPolHasta" value="" />
				</form>
