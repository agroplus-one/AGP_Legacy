...
<div id="panelEstadoContratacion" class="panelEstadoContratacion" style="color:#333333;-moz-border-radius:4px 4px 4px 4px;padding:0.2em;">
	...
	<div class="panelInformacion_content">
		<div id="panelInformacion" class="panelInformacion">		 
			...
			<fieldset>
				<legend class="literal">Reducciones previas</legend>	
				<span class="detalI" id="noModPrev">No constan reducciones previas</span>
				<span class="detalI" id="siModPrev">Existen reducciones previas</span>
			...
			<!-- Aviso -->
			<p align="left" class="detalI">Cualquier reducci&oacute;n que se env&iacute;e sobre una p&oacute;liza y sea aceptada total o parcialmente,
			anula cualquier reducci&oacute;n anterior sobre la misma p&oacute;liza que se encuentre en revisi&oacute;n administrativa.</p>
			<p align="left" class="detalI">Si existe una solicitud de reducci&oacute;n por otra v&iacute;a (fax, tel&eacute;fono, etc.) que no sea
			...
			administrativa.</p>
			<p align="left" class="detalI">¿Desea continuar con el alta del anexo de Reducci&oacute;n de Capital?</p>
		</div>		    
