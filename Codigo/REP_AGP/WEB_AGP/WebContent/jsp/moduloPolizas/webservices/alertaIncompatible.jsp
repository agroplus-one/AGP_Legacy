...
<html>
<head>
<title>Póliza Incompatible</title>
		...
		<script type="text/javascript">
			...
			function forzarPasoDefinitiva(idPoliza){
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="SwitchMenu('sub3');">
		...
		<div id="buttons">
			<table width="97%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td align="right">
						<a href="javascript:forzarPasoDefinitiva(${idpoliza});" class="bot">Forzar paso a definitiva</a>
		...
		<div class="conten" style="padding:3px;width:97%">
				<p class="titulopag" align="left">Póliza Incompatible</p>
