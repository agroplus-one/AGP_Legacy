...
<script type="text/javascript"
	src="jsp/moduloComisionesUnificado/informeImpagadosUnificado.js"></script>
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0"
	...
	<div class="conten" style="padding: 3px; width: 100%">
		<p class="titulopag" align="left">Consultas de Comisiones de
			impagados 2015 +</p>

		<form:form name="main3" id="main3"
			action="informeImpagadosUnificado.run" method="post"
			commandName="informeImpagadosBean">
			...
			<fieldset>
				...
				<table align="center">
					<tr>
						...
						<td colspan="3" width="29%"><c:choose>
								<c:when test="${perfil eq '0' || perfil eq '5'}">
									...
									<form:input path="nomentidad" cssClass="dato" id="desc_entidad"
										size="35" readonly="true" tabindex="2" />
								...
								<c:when test="${perfil eq '1'}">
									...
									<form:input path="nomentidad" cssClass="dato" id="desc_entidad"
										size="30" readonly="true" tabindex="2" />
								</c:when>
							</c:choose></td>
					...
					<tr>
						...
						<td width="12%"><spring:bind path="fechaEmisionRecibo">
								<input type="text" name="fechaEmisionRecibo" id="fechaemi"
									...
									value="<fmt:formatDate pattern="dd/MM/yyyy" value="${informeImpagadosBean.fechaEmisionRecibo}"/>" />
							</spring:bind> <input type="button" id="btn_fechaemision"
							name="btn_fechaemision" class="miniCalendario"
		...
		<div id="grid" style="width: 98%; margin: 0 auto;">
			${consultaImpagadosUnificado}</div>
