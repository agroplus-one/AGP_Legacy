...
<!-- incluir "jsp/moduloComisiones/informesComisionesHTML.js" 		-->


	<!--  popup Detalle de comisiones -->
	
	<div id="divPopupDetalleComisiones" class="parcelasRepWindow" style="top: 2%; left: 2%; color:#333333;-moz-border-radius:4px 4px 4px 4px;padding:0.2em;z-index:1005">
		<!--  header popup -->
		<div id="header-popup" style="padding:0.4em 1em;position:relative;color:#FFFFFF;font-weight:bold;-moz-border-radius:4px 4px 4px 4px;background:#525583;height:15px">
			...
			<a style="height:18px;margin:-10px 0 0;padding:1px;position:absolute;right:0.3em;top:50%;width:19px; font-family:arial;font-size:13px;font-weight:bold;cursor:hand;cursor:pointer">
				<span onclick="cerrarPopupDetalleComisiones()">x</span>
			</a>
		</div>
		...
		<div class="panelInformacion_content">
			<div id="panelInformacion" class="panelInformacion" >
				...
				<div style="margin-top:30px; clear: both">
				    <a class="bot" href="javascript:cerrarPopupDetalleComisiones()">Cerrar</a>
				</div>
			</div>
		</div>
	</div>
