...
//	var cobExistentes = "";    
//    for(i=0;i<document.datosExplotacionesAnexo.elements.length; i++){
//	    if(document.datosExplotacionesAnexo[i].type == 'checkbox') {
//	    	if (document.datosExplotacionesAnexo[i].checked == true){
//	    		document.datosExplotacionesAnexo[i].value = document.datosExplotacionesAnexo[i].value+"|S";    		
//	    	}else{
//	    		document.datosExplotacionesAnexo[i].value = document.datosExplotacionesAnexo[i].value+"|N";
//	    	}
//	    	cobExistentes+= document.datosExplotacionesAnexo[i].value +";";
//	    }
//    }
//    //alert(cobExistentes);
...
//	 for(h=0;h<document.datosExplotacionesAnexo.elements.length; h++){
//		 if(document.datosExplotacionesAnexo[h].type == 'checkbox') {
//			 var cob = document.datosExplotacionesAnexo[h].value.split('|');
//			 if (cob[2] == fila && cob[1] == modulo){
//				 //alert("encontrada");
//				 var encontrada = document.datosExplotacionesAnexo[h];
//				 h=1000;
//				 return encontrada;
//			 }
//		 }
...
//		    var mensajeError = "";
//		    if(document.datosExplotacionesAnexo[i].type == 'checkbox') {
//		    	var cob = document.datosExplotacionesAnexo[i].value.split('|');
//		    	
...
//	    				var cobFila = dameCoberturaFila(fila,modulo, document.datosExplotacionesAnexo);
//	    				//alert (cobFila);			
//	    				if (typeof cobFila != 'undefined'){
//	    					//alert("cob encontrada: "+cobFila.value);
//			    			if (vinculacion == 'S' && document.datosExplotacionesAnexo[i].checked == true){			
//			    				if (vinc_elegida == 'S'){
...
//			    			}  				
//			    			
//			    			if (vinculacion == 'N' && document.datosExplotacionesAnexo[i].checked == false){
//			    				if (vinc_elegida == 'S'){
