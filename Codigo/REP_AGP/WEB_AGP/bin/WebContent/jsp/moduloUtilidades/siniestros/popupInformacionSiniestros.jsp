			...
			<div id="panelInformacionSiniestro" style="color: #333333; -moz-border-radius: 4px 4px 4px 4px; padding: 0.2em;
				...
				<div class="panelInformacion_content" style="padding:15px;">
					<div id="panelInformacion" class="panelInformacion">
						...
						<!-- ESC-14561 ** MODIF TAM (13/07/2021) ** Inicio  -->	
							<!--<table style="width:90%; border-collapse:collapse;" class="LISTA">--> 
								
								<!-- La cabecera de la lista se imprime en la función pintarTabla de declaracionesSiniestros.jsp -->
								<!-- <tr> 
									<th class="cblistaImg">  </th> 
									<th style='text-align:center' class="cblistaImg"> F.Ocurrencia </th> 
									<th style='text-align:center' class="cblistaImg"> Riesgo </th> 
									<th style='text-align:center' class="cblistaImg"> Situación </th> 
									<th style='text-align:center' class="cblistaImg"> Serie </th>
									<th style='text-align:center' class="cblistaImg"> Número </th>
								</tr> -->
