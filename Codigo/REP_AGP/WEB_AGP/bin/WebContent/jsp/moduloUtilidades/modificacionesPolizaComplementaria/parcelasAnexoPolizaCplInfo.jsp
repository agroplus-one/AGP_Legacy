...
<title>Parcelas Modificacion del Complementario</title>
	...
	<script type="text/javascript" src="jsp/moduloUtilidades/modificacionesPolizaComplementaria/parcelasAnexoPolizaCplInfo.js"></script>
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="SwitchMenu('sub4');">
	...
	<div class="conten" style="padding: 3px; width: 97%">
		...
		<form:form name="formDistCoste" id="formDistCoste" action="calculoModificacion.html" method="post" commandName="anexoModificacionBean" >
			...
			<input type="hidden" id="redireccion" name="redireccion" value="pParcelasCplInfo" />
		...
		<form:form name="main3" id="main3" action="declaracionesModificacionPolizaComplementaria.html" method="post" commandName="capitalAseguradoBean">
			...
			<input type="hidden" id="vieneDeListadoAnexosMod" name="vieneDeListadoAnexosMod" value="${vieneDeListadoAnexosMod}"/>
			<input type="hidden" id="parcelasAnexoCplInfo" name="parcelasAnexoCplInfo" value="true"/>
			...
			<div id="grid">
			 	<display:table requestURI="declaracionesModificacionPolizaComplementaria.html?method=doVisualiza" class="LISTA" summary="parcelas"
