	      	...
	      	$('#main3').validate({
				...
				onfocusout: function(element) {
			 	...
			 	rules: {
			 		...
			 		"motivo" : {alMenosUno: true}
			 	},
			 	messages: {
			 		
			 		"fechadanios" : {required: "El campo Fec. Daños es obligatorio", dateITA: "Formato de fecha incorrecto"},
			 		"codmotivoriesgo" : {alMenosUno: "Si no informa el Motivo debe informar la Descripción"},
			 		"motivo" : {alMenosUno: "Si no informa la Descripción debe informar Motivo"}
			 	}
	      	});	
