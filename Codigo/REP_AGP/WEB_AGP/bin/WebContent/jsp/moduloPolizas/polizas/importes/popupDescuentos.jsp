...
function cerrarPopUpDescuentos(){
	...
	var descuentoElegido =  document.getElementById("dctoElegido-1");
	var calculada = document.getElementById("dctoPctComisionesCalculado");
	if(calculada != null && descuentoElegido != null){
		descuentoElegido.value = calculada.value;
	}
...
<html>
<head>
<form id="frmDescuentos" name="frmDescuentos" action="webservices.html"
	method="post">
	...
	<input type="hidden" name="descuentoLectura" id="descuentoLectura" value="${descuentoLectura}" />
	<input type="hidden" name="complementaria" id="complementaria" value="${complementaria}" />
						...
						<tr>
							...
							<td class="literal" align="center">% Descuento ${pctComDesc.descGrupoNegocio}: 
								...
								<c:if test="${descuentoLectura ne true &&
									...
									<!-- DNF 08/04/2021 ESC-13234 -->
									<input type="hidden" name="dctoPctComisionesCalculado" id="dctoPctComisionesCalculado" value="${pctComDesc.pctdescelegido}" />
