...
<html>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		<title>Elecci&oacute;n de la forma de pago</title>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"
			onload="SwitchMenu('sub3');javascript:generales.separaCuenta('${pagoPoliza.cccbanco}', '${pagoPoliza.cccbanco2}');">
	
		<%@ include file="/jsp/common/static/cabecera.jsp"%>
		<%@ include file="/jsp/common/static/menuGeneral.jsp"%>
		
		
		<!-- ESC-9321 01/06/2020 aï¿½ado la opcion de datosCabeceraConsulta.jsp que no estaba contemplada antes -->
		<c:choose>
		...
		<!-- FIN ESC-9321 01/06/2020 aï¿½ado la opcion de datosCabeceraConsulta.jsp que no estaba contemplada antes -->

		<div id="buttons">
			<table width="100%" cellspacing="2" cellpadding="2" border="0">
				<tr>
					
						<!-- PET.70105.FII DNF 25/02/2021 Incluir los botones Grabacion provisional, imprimir e imprimir reducida 
						si la linea contratada es > 01/02/2021-->
						<!-- ******* DNF INCIDENCIAS PET.70105.FII MOSTRAMOS LOS BOTONES PARA TODAS LAS LINEAS DE CONTRATACION
						...
						******* -->
						...
						<td align="center">
							...
							<c:if test="${not isLineaGanado}">
									<c:if test="${esPolPrincipal != 'false' }">
						...
						<td align="right">
							<c:if test="${modoLectura != 'modoLectura'}">
								...
								<a class="bot" href="#" id="btnGrProvisional"
									onclick="javascript:grabacionProvisional('${idpoliza}');">Grabaci&oacute;n Provisional</a>
								
								<a class="bot" href="#" id="btnSWConfirmacion2021" onclick="javascript:swConfirmacionLineaContraSup2021();" style="display: none">SW Confirmaci&oacute;n</a> 
							</c:if>
						</td>
		...
		<div class="conten">
			...
			<p class="titulopag" align="left">Elecci&oacute;n de la forma de pago</p>
			<%@ include file="/jsp/common/static/avisoErrores.jsp"%>
				<form:form method="post" name="pasarADefinitiva" id="pasarADefinitiva" action="eleccionFormaPago.html" commandName="pagoPoliza">
					...
					<input type="hidden" name="idDestinatarioDomiciliacion" id="idDestinatarioDomiciliacion" value="${destinatarioDomiciliacion2019}"/>
					<input type="hidden" name="idValorTitularCuenta" id="idValorTitularCuenta" value="${titularCuenta2019}"/>
					<input type="hidden" name="idLineaContratSuperior2019" id="idLineaContratSuperior2019" value="${lineaContratSuperior2019}"/>
					<input type="hidden" id="ibanAux" name="ibanAux" value="${pagoPoliza.iban}"/>
					<input type="hidden" id="ibanAux2" name="ibanAux2" value="${pagoPoliza.iban2}"/>
							
					<input type="hidden" name="caracterEnvioIbanAgroseguro" id="caracterEnvioIbanAgroseguro" value="${caracterEnvioIbanAgroseguro}"/>						
					...
					<input type="hidden" id="financiarOK" name="financiarOK" value="${financiarOK}" />
					
					<form:hidden path="formapago" id="formapago"/>					
					
					<input type="hidden" id="firmaTableta" name="firmaTableta" value="${pagoPoliza.poliza.colectivo.subentidadMediadora.firmaTableta}" />
					<input type="hidden" id="codTerminal" name="codTerminal" value="${sessionScope.codTerminal}" />					
					<input type="hidden" id="codUsuario" name="codUsuario" value="${sessionScope.usuario.codusuario}" />
					<input type="hidden" id="nifCifAseg" name="nifCifAseg" value="${pagoPoliza.poliza.asegurado.nifcif}" />
					<input type="hidden" id="tipoPersona" name="tipoPersona" value="${pagoPoliza.poliza.asegurado.tipoidentificacion == 'NIF' ? 'F' : 'J'}" />
					<input type="hidden" id="codEntidad" name="codEntidad" value="${pagoPoliza.poliza.colectivo.subentidadMediadora.id.codentidad}" />
					<input type="hidden" id="idInternoPe" name="idInternoPe" value="${idInternoPe}" />
					
					<div class="panelInformacion_content">
						<div id="panelInformacion" class="panelInformacion">
			
						<!--Panel superior de datos inofrmativos y oficina propietaria******************************************-->				
						...
						<table id="panelSuperior" align="center" >				
									<tr align="left">
										...
										<td class="literal" >Destinatario de la domiciliaci&oacute;n: </td>
										<td class="detalI" colspan = 2>
											<label id="lbl_sup_valor_destinatarioDomiciliacion" name="lbl_sup_valor_destinatarioDomiciliacion" ></label>
										</td>
										<td class="literal" >Titular de la cuenta: </td>
										<td class="detalI" colspan = 2>
											<label id="lbl_sup_valor_titularCuenta" name="lbl_sup_valor_titularCuenta" ></label>
										</td>
									</tr>
									<tr align="left">
										<td class="literal">IBAN Cobro Siniestros: </td>
										<td class="detalI" colspan = 2>
											<label id="lbl_sup_valor_IBAN2" name="lbl_sup_valor_IBAN2" ></label>
										</td>
										<td class="detalI" colspan = 4>&nbsp;</td>
									</tr>
									<tr align="left">
									...
									<tr align="left">
										<td class="literal">Importe 1&ordf; Fracci&oacute;n:</td>
										<td class="detalI">
						...
						<table id="tablaFormaPago" style="width:100%;">		
							<tr>
							
								<input type="hidden" id="idLineaContratSuperior2019" value="${lineaContratSuperior2019}"/>
								<input type="hidden" id="idEsSaeca" value="${esSaeca}"/>
											
									<!-- ...CARGO EN CUENTA... -->
									<td  class="literal" style="width:40%;">
									<fieldset >
										<legend>
												...
												<fieldset>
													...
													<table style="width:100%;align:center;">
														...
														<tr>
															...
															<td class="detalI">
																<label id="lbl_fec_primer_pago_col" name="lbl_fec_primer_pago_col" ><fmt:formatDate pattern="dd/MM/yyyy" value="${pagoPoliza.poliza.colectivo.fechaprimerpago}" /></label>
															</td>
															<td></td>
														</tr>
														<tr>
																...
																<tr>
																	...
																	<td class="literal" nowrap>
																		<spring:bind path="pctprimerpago">
																			...
																			<c:if test="${financiarOK == false}">
																				<form:input path="pctsegundopago" tabindex="7" id="pctsegundopagocliente" size="5" maxlength="5" cssClass="dato" cssStyle="text-align: left;" onchange="calculaImporteSegundoPago();rellenaPctPrimerPago(this)" disabled="true"/>%
																			</c:if>
																		</spring:bind>
																	</td>
																	<td class="literal">Fecha:</td>
																	<td class="literal" nowrap>
																		<spring:bind path="fechasegundopago">
																			...
																			<c:if test="${financiarOK == false}">
																				<input type="text" name="fechasegundopago1" tabindex="8" id="fechasegundopago1" size="10" maxlength="10" class="dato" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${pagoPoliza.fechasegundopago}" />"  onchange="if (!ComprobarFecha(this, document.pasarADefinitiva, 'Fecha segundo pago')) this.value='';" disabled="disabled"/>
																				<input type="button" id="btn_fechasegundopagomodificado" name="btn_fechasegundopagomodificado" class="miniCalendario" style="cursor: pointer;" disabled="disabled"/>
																			</c:if>
																		</spring:bind>
																		<!-- <input type="button" id="btn_fechasegundopagomodificado" name="btn_fechasegundopagomodificado" class="miniCalendario" style="cursor: pointer;" /> -->
																	...
																	<td class="literal" nowrap >
																		...
																		<c:if test="${financiarOK == false}">
																			<input type="text" name="importeSegundoPagoCliente" tabindex="9" id="importeSegundoPagoCliente" size="11" maxlength="10" value="${importeSegundoPagoCliente}" class="dato" readonly="readonly" style="text-align: right;" disabled="disabled"/>&#8364;
																		</c:if>	
																	</td>
																	<td></td>
																</tr>
										...
										<c:if test="${mpPagoC == false}">
											<table id="tablaNoDisponible" align="center" style="height:100px;">
												<tr>
													...
													Opci&oacute;n no disponible
													<td>
												</tr>
											</table>	
										</c:if>		
									</fieldset> <!--Creo que falta este elemento-->	
									...
									<!-- ...DOMICILIACION AGRO... -->
									<td  class="literal"  style="width:30%;">
									<div id="divDomiciliacionAgro">
									<fieldset>
										<legend> 
											<c:if test="${mpDomiAgro == true}">
												<form:radiobutton cssClass="literal" id="domiciliacionAgroId" tabindex="3" path="tipoPago" value="2" onclick="muestraDomiciliacionAgroseguro()" />Domiciliaci&oacute;n con Agroseguro
											</c:if>
											<c:if test="${mpDomiAgro == false}">
												<form:radiobutton cssClass="literal" id="domiciliacionAgroId" path="tipoPago" value="2" onclick="muestraDomiciliacionAgroseguro()" disabled="true"/>Domiciliaci&oacute;n con Agroseguro
											</c:if>
										</legend>
										<c:if test="${lineaContrataSup2021 == true}">
											<table id="tablaPagoDomic" align="center">
												<tr>
													<td class="literal" align="center">Domiciliaci&oacute;n del pago de la prima inicial y recibos.</td>
												</tr>
												<tr>
													<td class="literal" align="center">El primer pago se cargar&aacute; directamente por parte de Agroseguro en la cuenta indicada en la parte superior como IBAN Pago Prima, que deber&aacute; coincidir obligatoriamente con el IBAN de pago siniestro si el destinatario es el asegurado.</td>
												</tr>
												<tr>
													<td class="literal" align="center">La indemnizaci&oacute;n ser&aacute; abonada directamente por AGROSEGURO en la cuenta que aparece arriba IBAN cobro siniestros, que &uacute;nicamente podr&aacute; ser del asegurado, excepto en la l&iacute;nea 415 y l&iacute;nea 305, m&oacute;dulo E, que no aplica este apartado.</td>
												</tr>
												<tr>
													<td class="literal" align="center">Si desea modificar los datos de las cuentas deber&aacute; acceder al m&oacute;dulo de Administraci&oacute;n de Asegurados.</td>
							 					</tr>
											</table>
										</c:if>
										<c:if test="${lineaContrataSup2021 == false}">
											<table id="tablaPagoDomic" align="center">
												<tr>
													<td class="literal" align="center">Domiciliaci&oacute;n del pago de la prima inicial, recibos e indemnizaciones.</td>
												</tr>
												<tr>
													<td class="literal" align="center">El primer pago se cargar&aacute; directamente por parte de Agroseguro en la cuenta indicada en la parte superior.</td>
												</tr>
												<tr>
													<td class="literal" align="center">Si desea modificar el titular de la cuenta deber&aacute; acceder al m&oacute;dulo de Administraci&oacute;n de Asegurados.</td>
							 					</tr>
											</table>
										</c:if>
									</fieldset>
									...
									<!-- ...PAGO MANUAL... -->
									<td  class="literal"  style="width:25%;">
										...
										<table id="tablaPagoManual" align="center">
											<tr>
												...
												<td class="literal">
													...
													<img src="jsp/img/magnifier.png"style="cursor: hand;" id="lupaBancoDestino" onclick="javascript:lupas.muestraTabla('Banco','principio', '', '');"  alt="Buscar Banco" title="Buscar Banco" />
												<td>
											</tr>
											...
											<tr>
												...
												<td class="literal">
													<form:input path="importePago" id="importePago" tabindex="11"  cssClass="dato"/>
												</td>
											</tr>
											<tr>	
												...
												<td class="literal">
													<spring:bind path="fecha">
														<input type="text" name="fecha" tabindex="12"  id="tx_fechaPago" size="11" maxlength="10" class="dato"
											...
											<input type="hidden" id="cuenta1" name="cuenta1" />
											<input type="hidden" id="cuenta2" name="cuenta2" />
											<input type="hidden" id="cuenta3" name="cuenta3" />
											<input type="hidden" id="cuenta4" name="cuenta4" />
											<input type="hidden" id="cuenta5" name="cuenta5" />	
											<form:hidden path="cccbanco2" id="ccc2" />
											<form:hidden path="iban2" id="iban2" />
			...
			<form name="frmVolver" action="seleccionPoliza.html" method="post" id="frmVolver">				 
					...
					<input type="hidden" name="lineaContrataSup2021" id="lineaContrataSup2021" value="${lineaContrataSup2021}" />				
			...
			<form name="imprimirPoliza" id="imprimirPoliza" action="eleccionFormaPago.html" method="post">
		...
		<%@ include	file="/jsp/moduloPolizas/polizas/pago/popupListadoAsegurados.jsp"%>
