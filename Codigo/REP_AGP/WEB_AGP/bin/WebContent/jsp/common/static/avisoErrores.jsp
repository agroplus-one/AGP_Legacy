...
<div id="panelAlertasValidacion" class="errorForm">
</div>
<div id="panelMensajeValidacion" style="width:500px;color:black;border:1px solid #FFCD00;
			font-size:12px;font-style:italic;font-weight:bold;line-height:20px;background-color:#FCF6CF; display:none;margin-left:auto;margin-right:auto;">
</div>
