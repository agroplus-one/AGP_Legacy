...
public class VistaRotacionFiltro implements Filter 
{
    ...
    public VistaRotacionFiltro () {}

	public VistaRotacionFiltro(Long lineaSeguroId, String codmodulo,
	...
	public Criteria getCriteria(Session sesion) {
		Criteria criteria = sesion.createCriteria(VistaRotacion.class);
		criteria.add(getRotacion());	
		criteria.addOrder(Order.asc("id.codrotacion"));
	...
	private final Conjunction getRotacion() {
		...
		/* Por el resto de propiedades no se filtra */
