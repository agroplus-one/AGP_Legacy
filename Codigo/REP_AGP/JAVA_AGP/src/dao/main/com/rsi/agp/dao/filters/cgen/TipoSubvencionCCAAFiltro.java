...
public class TipoSubvencionCCAAFiltro implements Filter
{
	...
	{
		Criteria criteria = sesion.createCriteria(TipoSubvencionCCAA.class);
		
		if (this.codigosSubvenciones != null && this.codigosSubvenciones.size() > 0)
		{
			Criterion crit = Restrictions.in("codtiposubvccaa", this.getCodigosSubvenciones());
			criteria.add(crit);	
		}
