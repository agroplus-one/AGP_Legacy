...
public class VistaPracticaCulturalFiltro implements Filter 
{
    ...
    public VistaPracticaCulturalFiltro() {}
    
	public VistaPracticaCulturalFiltro(Long lineaSeguroId, String codmodulo,
			...
			BigDecimal codtipocapital, BigDecimal codsistemaproduccion,Date fGaranthasta) {
		super();
	...
	public Criteria getCriteria(Session sesion) {
		Criteria criteria = sesion.createCriteria(VistaPracticaCultural.class);
		
		criteria.add(getPracticaCultural());
		criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
		criteria.addOrder(Order.asc("id.despracticacultural"));
		
		return criteria;
	}
	
	private final Conjunction getPracticaCultural() {

		Conjunction c = Restrictions.conjunction();
		
		c.add(Restrictions.eq("codtipocapital", this.codtipocapital));
		
		if (FiltroUtils.noEstaVacio(this.fGaranthasta)) {
			c.add(Restrictions.eq("id.fgaranthasta", this.fGaranthasta));	
		}		
		...
		if (FiltroUtils.noEstaVacio(this.codsistemaproduccion))
		{
			c.add(Restrictions.eq("id.codsistemaproduccion", this.codsistemaproduccion));
		}
	...
	public void setFGaranthasta(Date garanthasta) {
		fGaranthasta = garanthasta;
	}
