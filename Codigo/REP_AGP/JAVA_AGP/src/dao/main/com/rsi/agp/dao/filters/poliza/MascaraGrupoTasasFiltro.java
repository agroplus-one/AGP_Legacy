...
public class MascaraGrupoTasasFiltro implements Filter {
	...
	public MascaraGrupoTasasFiltro(Long lineaseguroid, BigDecimal codcultivo,
			BigDecimal codvariedad, BigDecimal codprovincia,
			BigDecimal codcomarca, BigDecimal codtermino, Character subtermino,List<String> modulos) {
		super();
	...
	public MascaraGrupoTasasFiltro() {		
	}	

	@Override
	public Criteria getCriteria(Session sesion) {
			Criteria criteria = sesion.createCriteria(MascaraGrupoTasas.class);
