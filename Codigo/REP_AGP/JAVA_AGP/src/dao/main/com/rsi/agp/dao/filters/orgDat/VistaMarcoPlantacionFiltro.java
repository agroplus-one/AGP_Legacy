...
public class VistaMarcoPlantacionFiltro implements Filter {
    ...
    public VistaMarcoPlantacionFiltro(){
    	
    }
    
    public VistaMarcoPlantacionFiltro(Long lineaSeguroId, String codmodulo,
	...
	public Criteria getCriteria(Session sesion) {
		Criteria criteria = sesion.createCriteria(VistaMarcoPlantacion.class);
		criteria.add(getMarcoPlantacion());
		return criteria;
	}
	
	private final Conjunction getMarcoPlantacion() {
