...
public class AnexoRCSWCalculo implements java.io.Serializable {
	...
	public AnexoRCSWCalculo() {
		super();
	}

	public AnexoRCSWCalculo(Long id, ReduccionCapital reduccionCapital, String codusuario, Date fecha, String cupon,
