...
public class VistaTipoInstalacionFiltro implements Filter{
    ...
    public VistaTipoInstalacionFiltro() {}
    
    
    public VistaTipoInstalacionFiltro(Long lineaSeguroId, 
    		                          String codmodulo, 
	...
	public Criteria getCriteria(Session sesion) {
		Criteria criteria = sesion.createCriteria(VistaTipoInstalacion.class);
		criteria.add(getTipoInstalacion());
		
		return criteria;		
	}
	
	private final Conjunction getTipoInstalacion() {

		Conjunction c = Restrictions.conjunction();

		//c.add(Restrictions.eq("id.codtipoinstalacion", this.codtipoinstalacion));
		...
		if (this.codtipocapital != null){
			c.add(Restrictions.eq("id.codtipocapital", this.codtipocapital));
		}
