...
public class DeclaracionModificacionPolizaDao extends BaseDaoHibernate implements IDeclaracionModificacionPolizaDao {
	 ...
	 * @throws DAOException
	 */
	public AnexoModificacion saveAnexoModificacion (AnexoModificacion anexo,String codUsuario,Estado estado,boolean esAlta) throws DAOException {
		try {
