...
public class VistaDestinoFiltro implements Filter {
	...
	public VistaDestinoFiltro() {
	}

	public VistaDestinoFiltro(Long lineaSeguroId, String codmodulo, BigDecimal codcultivo, BigDecimal codvariedad,
	...
	public Criteria getCriteria(Session sesion) {
		Criteria criteria = sesion.createCriteria(VistaDestino.class);

		criteria.add(getDestinos());
	...
	private final Conjunction getDestinos() {

		Conjunction c = Restrictions.conjunction();

		c.add(Restrictions.disjunction().add(Restrictions.eq("codtipocapital", this.codtipocapital))
