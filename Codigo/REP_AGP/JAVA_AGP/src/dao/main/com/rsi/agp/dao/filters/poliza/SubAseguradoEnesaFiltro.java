...
public class SubAseguradoEnesaFiltro implements Filter {

	private Asegurado asegurado;
	private Poliza poliza;
	private BigDecimal codSubvencion;

	public SubAseguradoEnesaFiltro() {
		super();
	}	

	@Override
	public final Criteria getCriteria(final Session sesion) {
		final Criteria criteria = sesion.createCriteria(SubAseguradoENESA.class);
		...
		{
			criteria.add(Restrictions.eq("subvencionEnesa.id.codtiposubvenesa", codSubvencion));
		}
