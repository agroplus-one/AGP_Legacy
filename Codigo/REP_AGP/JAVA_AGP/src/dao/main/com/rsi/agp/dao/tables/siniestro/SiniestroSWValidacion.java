...
public class SiniestroSWValidacion implements java.io.Serializable {

	private static final long serialVersionUID = -4819237705896915234L;
	...
	public SiniestroSWValidacion() {
		super();
	}

	public SiniestroSWValidacion(Long id, Siniestro siniestro, String usuario, Date fecha) {
		this.id = id;
