...
public class SubAseguradoCcaaGanadoFiltro implements Filter {

	private Asegurado asegurado;
	private Poliza poliza;
	private BigDecimal codSubvencion;

	public SubAseguradoCcaaGanadoFiltro() {
		super();
	}
	...
	public final Criteria getCriteria(final Session sesion) {
		final Criteria criteria = sesion
				.createCriteria(SubAseguradoCCAAGanado.class);
		if (null != asegurado) {
		...
		if (null != codSubvencion) {
			criteria.add(Restrictions.eq(
					"subvencionCCAAGanado.id.codtiposubvccaa", codSubvencion));
		}
		return criteria;
	}
