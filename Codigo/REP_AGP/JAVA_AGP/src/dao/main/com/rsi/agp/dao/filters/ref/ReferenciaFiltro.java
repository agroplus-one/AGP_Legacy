...
public class ReferenciaFiltro implements Filter {
	...
	public ReferenciaFiltro(final Date fechaIni, final Date fechaFin) {
		this.fechaIni = fechaIni;
		this.fechaFin = fechaFin;
	}
	public ReferenciaFiltro(final String referenciaIni, final String referenciaFin) {
		this.referenciaIni = referenciaIni;
		this.referenciaFin = referenciaFin;
	}

	public ReferenciaFiltro(final boolean refLibres) {
		this.refLibres = refLibres;
	}

	public ReferenciaFiltro(final String referencia) {
		this.referencia = referencia;
	}

	@Override
	public final Criteria getCriteria(final Session sesion) {
		final Criteria criteria = sesion.createCriteria(ReferenciaAgricola.class);
