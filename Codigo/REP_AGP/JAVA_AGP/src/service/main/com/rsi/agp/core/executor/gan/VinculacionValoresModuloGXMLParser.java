...
import com.rsi.agp.dao.tables.cpl.gan.VinculacionValoresModuloG;
import com.rsi.agp.dao.tables.cpl.gan.VinculacionValoresModuloGId;

public class VinculacionValoresModuloGXMLParser extends GenericXMLParser {
	...
	public static void main(String[] args){
		...
		*/
		...
		if (args.length != 4) {
			System.out.println("Usage: java " + VinculacionValoresModuloGXMLParser.class.getName()
					+ " <XML that needs to be transformed>" + " <Output file>" + " <LineaseguroId>" + " <dateFormat>");
			System.exit(1);
		}
		try {
			VinculacionValoresModuloGXMLParser parser = new VinculacionValoresModuloGXMLParser();
			parser.setTagPrincipal(GenericXMLParser.TAG_RG);
			parser.procesarFichero(args[0], args[1], new Long(args[2]), args[1]);
		} catch (FileNotFoundException e) {
			System.out.println("Error al buscar el fichero el fichero de Vinculaciones Valores Modulo G " + e.getMessage());
			System.exit(2);
		} catch (SAXException e) {
			System.out.println("Error al crear el XMLReader " + e.getMessage());
			System.exit(3);
		} catch (IOException e) {
			System.out.println("Error de entrada/salida al parsear el fichero de Vinculaciones Valores Modulo G" + e.getMessage());
			System.exit(4);
	...
	protected String generaInsert(Object reg, String dateFormat) {
		VinculacionValoresModuloG registro = (VinculacionValoresModuloG)reg;
		String sql = "";
		sql += registro.getId().getLineaseguroid() + ";";
		
		if (registro.getCaracteristicaModuloByFkVincValModCaracM1G() != null){
			sql += registro.getCaracteristicaModuloByFkVincValModCaracM1G().getId().getCodmodulo() + ";";
			sql += registro.getCaracteristicaModuloByFkVincValModCaracM1G().getId().getFilamodulo() + ";";
			sql += registro.getCaracteristicaModuloByFkVincValModCaracM1G().getId().getColumnamodulo() + ";";
		}
		else{
			sql += ";;;";
		}
		
		if (registro.getCaracteristicaModuloByFkVincValModCaracM2G() != null){
			sql += registro.getCaracteristicaModuloByFkVincValModCaracM2G().getId().getFilamodulo() + ";";
			sql += registro.getCaracteristicaModuloByFkVincValModCaracM2G().getId().getColumnamodulo() + ";";
		}
		else{
			sql += ";;";
		}
		...
		if (registro.getPctFranquiciaElegibleByCodpctfranquiciavinc() != null){
			sql += registro.getPctFranquiciaElegibleByCodpctfranquiciavinc().getCodpctfranquiciaeleg() + ";";
		}
		else{
			sql += ";";
		}
		...
		// nuevos
		if (registro.getLimiteindemvinc() != null){
			sql += registro.getLimiteindemvinc() + ";";
		}
		else{
			sql += ";";
		}
		if (registro.getPergarantiasvinc() != null){
			sql += registro.getPergarantiasvinc() + ";";
		}
		else{
			sql += ";";
		}
		...
		// nuevos
		if (registro.getLimiteindemeleg() != null){
			sql += registro.getLimiteindemeleg() + ";";
		}
		else{
			sql += ";";
		}
		if (registro.getPergarantiaseleg() != null){
			sql += registro.getPergarantiaseleg() + ";";
		}
		else{
			sql += ";";
		}
	...
	protected Object generaRegistro(Object actual, String tag, XMLStreamReader parser, int id, Long lineaseguroid) {
		VinculacionValoresModuloG registro;
		if (actual == null){
			registro = new VinculacionValoresModuloG();
		}
		else{
			registro = (VinculacionValoresModuloG) actual;
		}
		
		if (this.getTagPrincipal().equals(tag)){
			VinculacionValoresModuloGId idActual = new VinculacionValoresModuloGId();
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "mod")).equals("") &&
				...
				registro.setCaracteristicaModuloByFkVincValModCaracM1G(cm_e);
			}
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "fModVinc")).equals("") &&
				...
				registro.setCaracteristicaModuloByFkVincValModCaracM2G(cm_v);
			}
			
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "numTab")).trim().equals("")){
				registro.setFichvinculacionexterna(new Long(parser.getAttributeValue(null, "numTab")));
			}
		}
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "franq")).trim().equals("")){
				...
				registro.setPctFranquiciaElegibleByCodpctfranquiciavinc(franq_vinc);
			}
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "limIndem")).trim().equals("")){
				registro.setLimiteindemvinc(new Long(parser.getAttributeValue(null, "limIndem")));
			}
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "perGarant")).trim().equals("")){
				registro.setPergarantiasvinc(new Long(parser.getAttributeValue(null, "perGarant")));
			}
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "limIndem")).trim().equals("")){
				registro.setLimiteindemeleg(new Long(parser.getAttributeValue(null, "limIndem")));
			}
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "perGarant")).trim().equals("")){
				registro.setPergarantiaseleg(new Long(parser.getAttributeValue(null, "perGarant")));
			}
		}
