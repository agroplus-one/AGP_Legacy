...
/**
 * A usar para los informes de listado de parcelas de anexo
 * @author U029823
 *
 */
public class BeanParcelaAnexo {
	...
	private String incrementoModificado;
	...
	public BigDecimal getSuperm() {
		return superm;
	}
	public void setSuperm(BigDecimal superm) {
		this.superm = superm;
	}
	...
	public String getIncrementoModificado() {
		return incrementoModificado;
	}
	public void setIncrementoModificado(String incrementoModificado) {
		this.incrementoModificado = incrementoModificado;
	}
