...
import com.rsi.agp.dao.tables.cpl.gan.MascaraFechaContratacion;
import com.rsi.agp.dao.tables.cpl.gan.MascaraFechaContratacionId;
import com.rsi.agp.dao.tables.org.DiccionarioDatos;

/**
 * Parser tabla 9424: Máscara de Fechas de contratación de Ganado nueva tabla
 * @author U029823
 *
 */
public class MascaraFechaContratacionXMLParser extends GenericXMLParser {
	
	public static void main(String[] args){
		
		//TEMPORAL
//		args = new String[4];
//		args[0] = "D:\\borrar\\MascaraFechasContratacionGanado.xml";
//		args[1] = "D:\\borrar\\MascaraFechasContratacionGanado.csv";
//		args[2] = "181";
//		args[3] = "null";
		//FIN TEMPORAL
		
		if (args.length != 4) {
			System.out.println("Usage: java " + MascaraFechaContratacionXMLParser.class.getName()
					+ " <XML that needs to be transformed>" + " <Output file>" + " <LineaseguroId>" + " <dateFormat>");
			System.exit(1);
		}
		try {
			MascaraFechaContratacionXMLParser parser = new MascaraFechaContratacionXMLParser();
			parser.setTagPrincipal(GenericXMLParser.TAG_RG);
			parser.procesarFichero(args[0], args[1], new Long(args[2]), args[3]);
		} catch (FileNotFoundException e) {
			System.out.println("Error al buscar el fichero el fichero de máscara de fechas de contratación " + e.getMessage());
			e.printStackTrace();
			System.exit(2);
			...
			System.out.println("Error de entrada/salida al parsear el fichero de máscara de fechas de contratación " + e.getMessage());
			e.printStackTrace();
			System.exit(4);
	...
	protected String generaInsert(Object reg, String dateFormat) {
		...
		MascaraFechaContratacion registro = (MascaraFechaContratacion)reg;
		String sql = "";
	...
	protected Object generaRegistro(Object actual, String tag, XMLStreamReader parser, int id, Long lineaseguroid) {
		...
		MascaraFechaContratacion registro;
		if (actual == null){
			registro = new MascaraFechaContratacion();
		}
		else{
			registro = (MascaraFechaContratacion) actual;
		}

		MascaraFechaContratacionId idActual = new MascaraFechaContratacionId();
