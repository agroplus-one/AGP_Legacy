 ...
 *
 */
public class ServicioCalcularHelper {

	private static final Log logger = LogFactory.getLog(ServicioCalcularHelper.class);
	
	/**
	 * Configura y realiza la llamada al servicio Web de Cálculo
	 */
	public Map<String, Object> doWork(Long idEnvio, Long idPoliza,
									  BigDecimal descuentoColectivo, 
									  String realPath, 
									  IPolizaDao polizaDao) throws CalculoServiceException {
		String xml = null;
		...
		if (!poliza.isPlanMayorIgual2015()){
			// Descuento del colectivo
			ObjectFactory o = new ObjectFactory();		
			if (descuentoColectivo == null) descuentoColectivo = poliza.getColectivo().getPctdescuentocol();
			// Por defecto ponemos un 4
			if (descuentoColectivo == null) descuentoColectivo = new BigDecimal(4);
