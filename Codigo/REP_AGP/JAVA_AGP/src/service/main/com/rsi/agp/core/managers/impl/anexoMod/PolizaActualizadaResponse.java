...
/**
 * Clase para almacenar los datos de la vuelta del servicio web de consulta de
 * póliza actualizada
 * 
 * @author U028783
 * 
 */
public class PolizaActualizadaResponse {
	...
	public PolizaActualizadaResponse() {
	}

	public PolizaActualizadaResponse(final es.agroseguro.seguroAgrario.contratacion.PolizaDocument polizaPrincipal,
