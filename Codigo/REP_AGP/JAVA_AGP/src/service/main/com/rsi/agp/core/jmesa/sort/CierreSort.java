...
public class CierreSort implements CriteriaCommand{
	...
	private void buildCriteria(Criteria criteria, String property, String order) {
        if (order.equals(Sort.ASC)) {// ***** ASC *****
    		...
    		if (property.equals("usuario")){
    			criteria.addOrder(Order.asc("usuario"));
    		}
    		
    		else if (property.equals("periodo")){
    			criteria.addOrder(Order.asc("periodo"));
    		}
    		
    		else if (property.equals("fechacierre")){
    			criteria.addOrder(Order.asc("fechacierre"));
    		}
        } else if (order.equals(Sort.DESC)) {// ***** DESC *****
    	
    		if (property.equals("usuario")){
    			criteria.addOrder(Order.desc("usuario"));
    		}
