...
import com.rsi.agp.dao.tables.cpl.gan.ValoresFactorEspecieAmbito;
import com.rsi.agp.dao.tables.cpl.gan.ValoresFactorEspecieAmbitoId;

/**
 * Parser tabla 0421: Valores del Factor por Especie y Ámbito de Ganado nueva
 * @author U029823
 *
 */
public class ValoresFactorEspecieAmbitoXMLParser extends GenericXMLParser {
	...
	public static void main(String[] args){
		...
		//TEMPORAL
//		args = new String[4];
//		args[0] = "D:\\borrar\\ValoresFactorEspecieAmbitoGanado.xml";
//		args[1] = "D:\\borrar\\ValoresFactorEspecieAmbitoGanado.csv";
//		args[2] = "181";
//		args[3] = "null";
		//FIN TEMPORAL
		...
		try {
			...
			System.out.println("Error al buscar el fichero el fichero de valores del Factor por Especie y Ámbito " + e.getMessage());
			e.printStackTrace();
			System.exit(2);
			...
			System.out.println("Error de entrada/salida al parsear el fichero de valores del Factor por Especie y Ámbito " + e.getMessage());
			e.printStackTrace();
			System.exit(4);
	...
	protected String generaInsert(Object reg, String dateFormat) {
		...
		ValoresFactorEspecieAmbito registro = (ValoresFactorEspecieAmbito)reg;
		String sql = "";
	...
	protected Object generaRegistro(Object actual, String tag, XMLStreamReader parser, int id, Long lineaseguroid) {
		...
		ValoresFactorEspecieAmbito registro;
		if (actual == null){
			registro = new ValoresFactorEspecieAmbito();
		}
		else{
			registro = (ValoresFactorEspecieAmbito) actual;
		}

		ValoresFactorEspecieAmbitoId idActual = new ValoresFactorEspecieAmbitoId();
