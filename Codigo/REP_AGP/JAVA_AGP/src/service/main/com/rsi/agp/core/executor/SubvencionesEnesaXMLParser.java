...
public class SubvencionesEnesaXMLParser extends GenericXMLParser {
	...
	public static void main(String[] args){
		...
		if (args.length != 4) {
			System.out.println("Usage: java " + SubvencionesEnesaXMLParser.class.getName()
					+ " <XML that needs to be transformed>" + " <Output file>" + " <LineaseguroId>" + " <dateFormat>");
			System.exit(1);
		}
		try {
			SubvencionesEnesaXMLParser parser = new SubvencionesEnesaXMLParser();
	...
	protected String generaInsert(Object reg, String dateFormat) {
		SubvencionEnesa registro = (SubvencionEnesa)reg;
		...
		sql += registro.getTipoSubvencionEnesa().getCodtiposubvenesa() + ";";
	...
	protected Object generaRegistro(Object actual, String tag, XMLStreamReader parser, int id, Long lineaseguroid) {
		...
		SubvencionEnesa registro;
		if (actual == null){
			registro = new SubvencionEnesa();
		}
		else{
			registro = (SubvencionEnesa) actual;
		}
		
		if (this.getTagPrincipal().equals(tag)){
			SubvencionEnesaId idActual = new SubvencionEnesaId();
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "tipSubv")).equals("")){
				TipoSubvencionEnesa tsENESA = new TipoSubvencionEnesa();
				tsENESA.setCodtiposubvenesa(new BigDecimal(parser.getAttributeValue(null, "tipSubv")));
				registro.setTipoSubvencionEnesa(tsENESA);
			}
			...
			if (!StringUtils.nullToString(parser.getAttributeValue(null, "ratio")).equals("")){
				registro.setRatio(new BigDecimal(parser.getAttributeValue(null, "ratio")));
			}
