...
public class FilaCompElegible {
    ...
    public FilaCompElegible(){
    	super();
    }
    
    public FilaCompElegible(FilaComparativa filaComp){
    	super();
    	lineaseguroid = filaComp.getLineaseguroid();
        codmodulo = filaComp.getCodmodulo();
        desmodulo = filaComp.getDesmodulo();
        codconceptoppalmod = filaComp.getCodconceptoppalmod();
        desconceptoppalmod = filaComp.getDesconceptoppalmod();
        codriesgocubierto = filaComp.getCodriesgocubierto();
        desriesgocubierto = filaComp.getDesriesgocubierto();
        codconcepto = filaComp.getCodconcepto();
        nomconcepto = filaComp.getNomconcepto();
        codvalor = filaComp.getCodvalor();
        desvalor = filaComp.getDesvalor();
        filamodulo = filaComp.getFilamodulo();
        columnamodulo = filaComp.getColumnamodulo();
    }
