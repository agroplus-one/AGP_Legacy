...
import com.rsi.agp.core.manager.impl.anexoRC.solicitudModificacion.SolicitudReduccionCapBean;
...
public class SolicitudReduccionCapController extends BaseMultiActionController {
	
	private ISolicitudReduccionCapManager solicitudReduccionCapManager;
	private static final Log logger = LogFactory.getLog(SolicitudReduccionCapController.class);
	...
	public void doSolicitudModificacion (HttpServletRequest request, HttpServletResponse response) {
		...
		if (referencia != null && plan != null) {
			...
			bean = this.solicitudReduccionCapManager.solicitarModificacion(referencia, plan, realPath, usuario != null ? usuario.getCodusuario() : "");
		}
	...
	public void doAnularCupon (HttpServletRequest request, HttpServletResponse response) {
		...
		if (idCupon != null) {
			resultado = this.solicitudReduccionCapManager.anularCupon(id != null ? id.longValue() : null, 
