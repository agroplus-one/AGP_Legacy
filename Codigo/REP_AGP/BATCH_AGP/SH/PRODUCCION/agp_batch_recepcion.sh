...
main()
{
    ...
    log "Inicio de la recepcion de ficheros de Agroseguro $LD_LIBRARY_PATH"  | tee -a $LOG_NAME_1;
    ...
    log "Resultado de la recepcion de ficheros de Agroseguro: $resultado"  | tee -a $LOG_NAME_1;
