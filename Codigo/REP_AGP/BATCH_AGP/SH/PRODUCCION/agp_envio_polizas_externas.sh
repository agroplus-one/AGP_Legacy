#!/bin/ksh
#########################################################
## Envío de pólizas externas a Agroseguro ##
##                                                     ##
##                                                     ##
##                                                     ##
##                                                     ##
...
main()
{
    ...
    LOG_NAME_1="${PATH_LOG}"/AGP_ENVIO_PLZ_EXTERNAS_"${fecha}".log
	...
	$javaPath64Prop/java -jar -Xms256m -Xmx2048m -Djava.library.path=$LD_LIBRARY_PATH $fileManagerProp/EnvioPolizasExternas.jar	
