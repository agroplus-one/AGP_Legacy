...
## (8- Pdte. validación o 2-Grabación Provisional)     ##
## cuyo último día de contratación sea el del día      ##
## de ejecución					       ##
##                                                     ##
##                                                     ##
## Se envia un correo recordatorio de confirmación de  ##
## pólizas.					       ##			
## 						       ##            
##                                                     ##
##  REVISIONS:                                         ##
...
function doWork
{
	...
	log "Comenzamos con el envio de recordatorio de confirmacion polizas."  | tee -a $LOG_NAME_1;	
	
	log "fecha recibida por parametro: $1" | tee -a $LOG_NAME_1;	
	...
	cierre=`sqlplus -s /@$oracleSIDProp << EOF
        ...
        begin
                resultado := o02agpe0.PQ_RECORDATORIO_CONFIRMACION.enviar_record_polizas('$1');
