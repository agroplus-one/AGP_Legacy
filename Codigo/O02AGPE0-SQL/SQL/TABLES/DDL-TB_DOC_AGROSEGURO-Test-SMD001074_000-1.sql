...
alter table TB_DOC_AGROSEGURO
  drop constraint FK_DOC_AGRO_LINEASEGUROID;
...
--select * from O02AGPE0.TB_DOC_AGROSEGURO
--select * from o02agpe0.tb_lineas lin where lin.lineaseguroid = 62 -->2011-306
--select * from o02agpe0.tb_lineas lin where lin.lineaseguroid = 8301 --> 2017-999

--- =======================================================================================

--- PASO 3 -- HACER EL DROP del campo LINEASEGUROID
--- =======================================================================================
-- Drop columns 
alter table TB_DOC_AGROSEGURO drop column LINEASEGUROID;
