create or replace view o02agpe0.vw_informe_colaboradores_2015 as
  ...
  from (select idcierre,
          ...
          from (select q.idcierre,
                       ...
                       decode(subent.ind_gastos_adq,
                              1,
                              nvl(q.comsmed, 0) + nvl(q.gasadq, 0),
                              0,
                              nvl(q.comsmed, 0),
                              0) as importe,
                       decode(subent.tipoidentificacion,
                 ...
                 where subent.codentidad between 3000 and 3999
                   and subent.codsubentidad <> 0)
